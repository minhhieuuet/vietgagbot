...
function sendMessage(senderId, message) {
  request({
    ...
    qs: {
      access_token: "EAACgO93nvrkBAIg7MhCTpbriwvnvpjcgPkrYXQT6uOpIjHAbhakVEH5VeqJlTyW777SwZBm9hDqZAA94kwx8dwtuzCEGKZAJtamrIZALWcZC9U6Hy1uKFHrnSu2W7RViVpZAceVi5CQNcQZARnvKUgQfZAGdgqZBC8bOOcVqjy7ZBPowZDZD",
    },
    method: 'POST',
    json: {
      recipient: {
